archipelago_plot <- function(df1, df2, 
                             ...
                             crit_val = NULL,
                             point_size = 1,
                             output_path = "../output/archipelago_plot.pdf"
                             ) {
...
p_raw <- 
  ...
  guides(color = "none") 
p_raw
ggsave("../output/raw_vsat_plot.pdf", width = 6, height = 4)
...
# 8 color themes:
# 'retro', 'metro', 'summer', 'messenger', 'sunset', 'alice', 'yawn', 'lawless'
output_path = "../output/archipelago_plot_custom_color.pdf"
...
custom_colors = c("#9abfd8", "#cac1f3", "#371c4b", "#2a5b7f") # alice theme colors
plot_title <- "Title"
...
color_themes <- c('retro', 'metro', 'summer', 'messenger', 'sunset', 'alice', 'yawn', 'lawless')
